'''Class definition for Sales Receipt

This module contains the class to be used for the Sales Receipt.

The class created collects the data for the sales receipt, and provides
methods for:
...
#Must set attribute values in main program
    def _init_(itemName, itemQty, itemPrice, sale):
